 ...
 * /session-breakdown
 *
 * Interactive TUI that analyzes ~/.pi/agent/sessions and shows usage over
 * last 7/30/90 days: sessions, messages, tokens, cost by model.
 * GitHub-contributions-style calendar graph.
 *
 * Forked from: https://github.com/mitsuhiko/agent-stuff/blob/main/pi-extensions/session-breakdown.ts
